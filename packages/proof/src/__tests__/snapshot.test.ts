...
import { buildProofSnapshot, createProofSnapshot } from '../snapshot.js';
...
test('2 duplicate IDs fail deterministically', async (t) => {
  ...
  await t.throwsAsync(buildProofSnapshot(root), {
