...
/** Every relation field the Proof preset can produce, per collection. */
...
/** Introspects which fields each Proof type actually exposes. */
...
export function buildProofQuery(schema: SchemaProbeResult | null): string {
...
export interface ProofQueryResult {
