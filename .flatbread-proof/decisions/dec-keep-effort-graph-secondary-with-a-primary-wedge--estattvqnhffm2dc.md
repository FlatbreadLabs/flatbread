...
Flatbread's relational-content wedge. Promote it only after real multi-session
retrieval, token-based benchmark, read-surface parity, and external
rediscovery evidence. Continue to use the graph to dogfood planning rather
than treating fixture results as product validation.
