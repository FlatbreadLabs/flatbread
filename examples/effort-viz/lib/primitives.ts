/**
 * Primitive metadata — the single source of truth for how each Effort Graph
 ...
 *
 * Vocabulary follows `.agents/skills/effort-graph/glossary.md` — these are
...
import type { ColorMode, Oklch } from './oklch';
...
export const PRIMITIVES: Record<GraphNodeKind, PrimitiveMeta> = {
  effort: {
    ...
    label: 'Effort',
    plural: 'Efforts',
    description: 'The anchor for one thread of work. Every record belongs to exactly one.',
    glyph: 'ring',
  ...
  issue: {
    ...
    label: 'Issue',
    plural: 'Issues',
    description: 'A tracked item needing attention — question, defect, gap, or blocker.',
    glyph: 'diamond',
    tone: { c: 0.15, h: 72 },
  },
  finding: {
